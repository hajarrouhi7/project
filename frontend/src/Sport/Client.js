    ...
    <div>
      ...
      <div className="d-flex justify-content-center mb-3 me-5 " style={{width:"40vw"}} >
       ...
       <div className='text-center '> < PersonAddAlt1Icon  color='success'sx={{ fontSize: 50 }}/></div>
        ...
        <div className='d-flex justify-content-around w-250 mb-3'>
          <TextField id="outlined-basic" label="password" variant="outlined"  className='' focused={foc} color={color5}  error={isValid5}  onChange={(e)=>{handlpassword(e.target.value)}}/>
          <TextField id="outlined-basic" label="Confpassword" variant="outlined"  className='' focused={foc} color={color6}  error={isValid6}  onChange={(e)=>{handlconfpassword(e.target.value)}}/>
          </div>
